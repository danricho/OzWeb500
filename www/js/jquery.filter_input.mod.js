        ...
        filter_input: function(options) {
          ...
          function filter_input_function(event) {
            ...
            if (regex.test(string)) {
              if (typeof(options.allowed_feedback) == 'function'){
                options.allowed_feedback.call(this, string);
              }
              return true;
            } else if (typeof(options.disallowed_feedback) == 'function') {
              options.disallowed_feedback.call(this, string);
            }
